...
export default function Page() {
  return (
    <ArticleLayout
      title='Debt snowball'
      description='Payoff method that clears the smallest balance first.'
      crumbs={[{ label: "Home", href: "/" }, { label: "Glossary", href: "/glossary" }, { label: 'Debt snowball' }]}
    ...
    >
      <p>
        ...
        toward the smallest balance. When that debt clears, its minimum joins the attack on the next-smallest balance.
      </p>
    </ArticleLayout>
  );
}
